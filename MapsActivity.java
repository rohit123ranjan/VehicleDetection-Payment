...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnRestaurant = (Button) findViewById(R.id.B_resturant);
        ...
        Button id_to = (Button) findViewById(R.id.B_to);
        id_to.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private String getDirectionUrl(){
        ...
        googleDirectionsUrl.append("&key="+"AIzaSyC9QwkXTqhNlL5zeP_4sOp30IrPUQcOm6A");
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyBNfaH1S9Zq0mZjiiQeQrlSfg8wSe8qLKw");
